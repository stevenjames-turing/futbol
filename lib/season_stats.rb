...
module SeasonStats
  ...
  def winningest_coach(season)
    ...
    number_of_games_coached = games_played_by_coach.transfrom_values {|value| value.count}
    games_won = games_played_by_coach.transfrom_values {|value| value.select {|game| game.result == "WIN"}}.transfrom_values {|value| value.count}
